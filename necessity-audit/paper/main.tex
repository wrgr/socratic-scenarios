...
smoothly to a $\le\!0.05$ floor across a dense 21-point LoRA-scale grid in \emph{five} model
families with five distinct base-model lineages (Qwen2.5-3B, Phi-3.5-mini, Zephyr-7B, Llama-3.1-8B,
OLMo-2-7B; three seeds each), with each family's transition knee at a different point on the gradient.
