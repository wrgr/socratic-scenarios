...
it in \emph{five} different model families from five different labs (Qwen, Phi, Zephyr, Llama, and
OLMo), three seeds each, and all five give the same clean ``dose-response'' curve---sliding from fully
