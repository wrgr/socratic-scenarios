...
the verdict flipping \textsc{corpus-bound}$\to$\textsc{leaking} as the facts are internalized. This is
the clean dose-response, in a domain we did not build a simulator for---answering the objection that
the measure is an artifact of one hand-built environment. (Necessity here is measured closed-book:
