...
survived-rate per probe type), a \emph{benign-relearning} test (do a few steps of fine-tuning
restore the behavior---gone vs.\ merely suppressed), and seed/method variance rather than a
single run. Two would-be $2\times2$ confounds do not bite here: the instrument scores a
