...
sizes---a real charted danger for external validity, a medium-effect routing convention, and a
conflicting fact about another vessel's intention---so necessity is validated as a distribution across
probe kinds, not a single test.
