...
% NOTE: tmlr.sty here is a PLACEHOLDER adapted from the bundled NeurIPS/ICLR
...
Gemini-2.5-flash reads as a reasoner, relying on the local rule on all three override reaches
