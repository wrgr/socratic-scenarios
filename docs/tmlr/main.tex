...
\citep{knowingdoing2026}. Two interventions localize it. \emph{Eliciting} the knowledge by
reason-then-decide prompting closes the gap---necessity falls to $\approx\!0.3$, while a naive-model
reasoning control still grounds, so it is the taught knowledge being surfaced, not reasoning alone.
